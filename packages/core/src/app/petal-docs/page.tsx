...
cd my-petal-host
pnpm install
petal setup   # configure backend URL, theme, apps
...
docker compose up`} />
            ...
            <CodeBlock label="generated files" code={`petal.config.ts     # apps + theme (single source of truth)
    ...
    afterRequest: async (response) => {
      ...
      return response
          ...
          <section id="config-reference" className="scroll-mt-6">
            ...
            <PropTable rows={[
              { name: "backend", type: "string",               desc: "Frappe backend URL fallback. Takes effect only if FRAPPE_BACKEND_URL is not set in .env." },
              ...
              { name: "theme",   type: "Partial<PetalTheme>", default: "{}", desc: "Global theme overrides applied before app-level overrides." },
            ]} />
